...
response.title = 'Truth Table Generator' #.join(word.capitalize() for word in request.application.split('_'))
response.subtitle = T('Logical Expression Tester')
right_sidebar_enabled = True
## read more at http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'Toshihiko ZAITSU <c865412@gmail.com>'
response.meta.description = 'truth table generator'
